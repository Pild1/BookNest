export const statuses = ['Unread', 'In Progress', 'Finished'];
...
export const initialBooks = [
  {
    ...
    status: 'In Progress',
    rating: 5,
    notes: 'Elegant world-building and political tension. Good candidate for a reread.',
    isWishlist: false,
    isDeleted: false,
  ...
  },
  {
    ...
    status: 'Finished',
    rating: 4,
    notes: 'Quiet and precise, with unsettling tenderness.',
    isWishlist: false,
    isDeleted: false,
  ...
  },
  {
    ...
    status: 'In Progress',
    rating: 4,
    notes: 'Strong narrative voice; tracking progress because it is a long one.',
    isWishlist: false,
    isDeleted: false,
